/* ===========================================================
# sphere-stock-xml-import - v0.0.29
# ==============================================================
...
StockXmlImport = (function(_super) {
  ...
  StockXmlImport.prototype.mapStock = function(xmljs, channelId) {
    var appointedQuantity, d, date, expectedDelivery, k, row, sku, stocks, _ref;
    stocks = [];
    _ref = xmljs.row;
    for (k in _ref) {
      row = _ref[k];
      sku = xmlHelpers.xmlVal(row, 'code');
      stocks.push(this.createInventoryEntry(sku, xmlHelpers.xmlVal(row, 'quantity')));
